...
[psnic, pslwc, ptsoil, zrfrz]...
    = refreeze (psnowc, psnic, pslwc, ptsoil, c );
        ...
        % Update BV 2018: Density and temperature tracker
        if c.track_temp
            c.T_firn_after_refreeze = ptsoil;
        end
